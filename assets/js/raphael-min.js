...
(function () {
  ...
  aI.version = "1.5.2";
  var a = /[, ]+/,
    bp = { circle: 1, rect: 1, path: 1, ellipse: 1, text: 1, image: 1 },
    bn = /\{(\d+)\}/g,
    bE = "prototype",
    ag = "hasOwnProperty",
    aa = document,
    aQ = window,
    r = { was: Object[bE][ag].call(aQ, "Raphael"), is: aQ.Raphael },
    bz = function () {
    ...
    ap = { NaN: 1, Infinity: 1, "-Infinity": 1 },
    c = /^(?:cubic-)?bezier\(([^,]+),([^,]+),([^,]+),([^\)]+)\)/,
    ad = ao.round,
    D = "setAttribute",
    aj = parseFloat,
    ...
    n = { hs: 1, rg: 1 },
    ba = /,?([achlmqrstvxz]),?/gi,
    aR = /([achlmqstvz])[\s,]*((-?\d*\.?\d*(?:e[-+]?\d+)?\s*,?\s*)+)/gi,
    aG = /(-?\d*\.?\d*(?:e[-+]?\d+)?)\s*,?\s*/gi,
    aO = /^r(?:\(([^,]+?)\s*,\s*([^\)]+?)\))?/,
    bm = function (e, d) {
      return e.key - d.key;
  ...
  aI.is = function (d, b) {
    ...
    return (
      ...
      aT.call(d).slice(8, -1).toLowerCase() == b
    );
  };
  ...
  var a9 = function (E) {
      if (aI.vml) {
        ...
        a9 = aA(function (e) {
          R.style.color = e;
          return aa.defaultView
            .getComputedStyle(R, aP)
  ...
  aI.hsl2rgb = function (bH, bO, E, e) {
    ...
    bM.hex =
      "#" +
      (16777216 | bM.b | (bM.g << 8) | (bM.r << 16)).toString(16).slice(1);
  ...
  aI.rgb2hsb = function (b, d, bH) {
    ...
    var S = m(b, d, bH),
      ...
      R = S;
    if (e == S) {
      return { h: 0, s: 0, b: S, toString: aC };
    } else {
      var bI = S - e;
      i = bI / S;
      if (b == S) {
    ...
    return { h: E, s: i, b: R, toString: aC };
  };
  ...
  aI.getRGB = aA(function (b) {
    ...
    !(n[ag](b.toLowerCase().substring(0, 2)) || b.charAt() == "#") &&
      (b = a9(b));
    var E,
      d,
      e,
  ...
  var ai = aA(function (bL) {
      ...
      var b = bi[bB](0, E),
        bJ = bi[bB](0, d);
      return { x: b, y: bJ, width: m[bB](0, E) - b, height: m[bB](0, d) - bJ };
    }),
    aS = function (S) {
      var e = [];
    ...
    Z = function (bO, cj, bX, bV, bP, bJ, E, bN, ci, bQ) {
      ...
      if (bQ) {
        ...
        for (var ca = 0, b0 = b1[s]; ca < b0; ca++) {
          bZ[ca] =
            ca % 2 ? cf(b1[ca - 1], b1[ca], b).y : cf(b1[ca], b1[ca + 1], b).x;
        }
        return bZ;
      }
    },
    ...
    a6 = aA(function (i, d, R, E, bQ, bP, bM, bJ) {
      ...
      return {
        min: { x: bi[bB](0, bN), y: bi[bB](0, bK) },
        max: { x: m[bB](0, bN), y: m[bB](0, bK) },
      };
    }),
    V = aA(
      function (bP, bK) {
        var E = y(bP),
          bL = bK && y(bK),
          bM = { x: 0, y: 0, bx: 0, by: 0, X: 0, Y: 0, qx: null, qy: null },
          ...
          S = function (bQ, bR) {
            ...
            !(bQ[0] in { T: 1, Q: 1 }) && (bR.qx = bR.qy = null);
            switch (bQ[0]) {
              case "M":
                bR.X = bQ[1];
                bR.Y = bQ[2];
  ...
  if (aI.svg) {
    ...
    var x = function (b, i) {
      ...
      var e = new aU(d, i);
      e.type = "path";
      an(e, { fill: "none", stroke: "#000", path: b });
      return e;
    };
    var g = function (E, bO, b) {
      ...
      bO = bC(bO)[bs](aO, function (bS, i, bT) {
        ...
        if (i && bT) {
          ...
          S = aj(bT);
          var bR = (S > 0.5) * 2 - 1;
          bl(bI - 0.5, 2) + bl(S - 0.5, 2) > 0.25 &&
            (S = ao.sqrt(0.25 - bl(bI - 0.5, 2)) * bR + 0.5) &&
            S != 0.5 &&
            (S = S.toFixed(5) - 0.00001 * bR);
        }
        return aP;
      });
      bO = bO[I](/\s*\-\s*/);
      ...
      bh(E, { fill: "url(#" + e.id + ")", opacity: 1, "fill-opacity": 1 });
      bQ.fill = aP;
      bQ.opacity = 1;
      bQ.fillOpacity = 1;
      return 1;
        ...
        S = function (b3, b2) {
          ...
          if (b2) {
            var b0 = b3.attrs["stroke-width"] || "1",
              bY =
                { round: b0, square: b0, butt: 0 }[
                  b3.attrs["stroke-linecap"] || bW["stroke-linecap"]
                ] || 0,
              b1 = [];
            var bZ = b2[s];
            while (bZ--) {
        ...
        if (bW[ag](bR)) {
          ...
          switch (bR) {
            ...
            case "clip-rect":
              ...
              if (d[s] == 4) {
                bN.clip &&
                  bN.clip.parentNode.parentNode.removeChild(bN.clip.parentNode);
                var e = bh("clipPath"),
                  bT = bh("rect");
                e.id = j();
                bh(bT, { x: d[0], y: d[1], width: d[2], height: d[3] });
                e[bk](bT);
                bN.paper.defs[bk](e);
                bh(bS, { "clip-path": "url(#" + e.id + ")" });
                bN.clip = bT;
              }
              if (!bP) {
                var bV = aa.getElementById(
                  bS.getAttribute("clip-path")[bs](/(^url\(#|\)$)/g, aP),
                );
            ...
            case "scale":
              ...
              bN.scale(
                +bH[0] || 1,
                +bH[1] || +bH[0] || 1,
                isNaN(aj(bH[2])) ? null : +bH[2],
                isNaN(aj(bH[3])) ? null : +bH[3],
              );
              break;
            case a4:
              var R = bC(bP).match(h);
              if (R) {
                ...
                bX.onload = function () {
                  bh(e, { width: this.offsetWidth, height: this.offsetHeight });
                  bh(bM, {
              ...
              if (!i.error) {
                delete bW.gradient;
                delete bO.gradient;
                !aI.is(bO.opacity, "undefined") &&
                  aI.is(bW.opacity, "undefined") &&
                  bh(bS, { opacity: bO.opacity });
                !aI.is(bO["fill-opacity"], "undefined") &&
                  aI.is(bW["fill-opacity"], "undefined") &&
                  bh(bS, { "fill-opacity": bO["fill-opacity"] });
              } else {
                if (
                  ({
                    circle: 1,
            ...
            case "stroke":
              ...
              break;
            case "gradient":
              (({ circle: 1, ellipse: 1 })[ag](bN.type) ||
                bC(bP).charAt() != "r") &&
                g(bS, bP, bN.paper);
              break;
            case "opacity":
              if (bO.gradient && !bO[ag]("stroke-opacity")) {
                bh(bS, { "stroke-opacity": bP > 1 ? bP / 100 : bP });
              }
            case "fill-opacity":
              if (bO.gradient) {
                var b = aa.getElementById(
                  bS.getAttribute(a4)[bs](/^url\(#|\)$/g, aP),
                );
                if (b) {
      ...
      P = function (b, E) {
        ...
        var bJ = b.attrs,
          ...
          bL = d.firstChild
            ? T(
                aa.defaultView
                  .getComputedStyle(d.firstChild, aP)
        ...
        if (E[ag]("text")) {
          ...
          for (R = 0, bK = e[s]; R < bK; R++) {
            R && bh(e[R], { dy: bL * o, x: bJ.x });
          }
        }
        bh(d, { y: bJ.y });
        var S = b.getBBox(),
          bI = bJ.y - (S.y + S.height / 2);
        bI && aI.is(bI, "finite") && bh(d, { y: bJ.y + bI });
      },
      aU = function (d, b) {
        var i = 0,
          e = 0;
    ...
    aU[bE].rotate = function (d, b, i) {
      ...
      if (this._.rt.deg) {
        this.transformations[0] = aI.format(
          "rotate({0} {1} {2})",
          this._.rt.deg,
          b,
          i,
    ...
    aU[bE].getBBox = function () {
      ...
      if (this.type == "text") {
        ...
        for (var b = 0, E = this.node.getNumberOfChars(); b < E; b++) {
          ...
          S.y < bH.y && (bH.y = S.y);
          S.y + S.height - bH.y > bH.height &&
            (bH.height = S.y + S.height - bH.y);
    ...
    aU[bE].attr = function (b, bJ) {
      ...
      for (var bK in this.paper.customAttributes) {
        if (
          this.paper.customAttributes[ag](bK) &&
          d[ag](bK) &&
          aI.is(this.paper.customAttributes[bK], "function")
        ) {
    ...
    aU[bE].blur = function (d) {
      ...
      if (+d !== 0) {
        ...
        b.attrs.blur = d;
        e.id = j();
        bh(i, { stdDeviation: +d || 1.5 });
        e.appendChild(i);
        b.paper.defs.appendChild(e);
        b._blur = e;
        bh(b.node, { filter: "url(#" + e.id + ")" });
      } else {
        if (b._blur) {
    ...
    var ae = function (d, b, R, E) {
      ...
      v = function (e, S, b, bH, d, R) {
        ...
        e.canvas && e.canvas[bk](E);
        var i = new aU(E, e);
        i.attrs = { x: b, y: bH, width: d, height: R, src: S };
        i.type = "image";
        return i;
      },
      ak = function (d, b, R, E) {
        var i = bh("text");
        bh(i, { x: b, y: R, "text-anchor": "middle" });
        d.canvas && d.canvas[bk](i);
        var e = new aU(i, d);
        e.attrs = {
          x: b,
      ...
      F = function () {
        ...
        if (e == 1) {
          S.style.cssText =
            "position:absolute;left:" + d + "px;top:" + bH + "px";
          aa.body[bk](S);
        } else {
          if (e.firstChild) {
  ...
  if (aI.vml) {
    var N = { M: "m", L: "l", C: "c", Z: "x", m: "t", l: "r", c: "v", z: "x" },
      aN = /([clmz]),?([^clmz]*)/gi,
      bx = / progid:\S+Blur\([^\)]+\)/g,
      bF = /-?[^,\s-]+/g,
      aX = 1000 + aH + 1000,
    ...
    an = function (bJ, bQ) {
      ...
      bQ["font-family"] &&
        (S.fontFamily =
          '"' + bQ["font-family"][I](",")[0][bs](/^['"]+|['"]+$/g, aP) + '"');
      bQ["font-size"] && (S.fontSize = bQ["font-size"]);
      bQ["font-weight"] && (S.fontWeight = bQ["font-weight"]);
      bQ["font-style"] && (S.fontStyle = bQ["font-style"]);
      if (
        bQ.opacity != null ||
        bQ["stroke-width"] != null ||
        bQ.fill != null ||
        bQ.stroke != null ||
        bQ["stroke-width"] != null ||
        bQ["stroke-opacity"] != null ||
        bQ["fill-opacity"] != null ||
        bQ["stroke-dasharray"] != null ||
        bQ["stroke-miterlimit"] != null ||
        bQ["stroke-linejoin"] != null ||
        bQ["stroke-linecap"] != null
      ) {
        bN = bJ.shape || bN;
        ...
        if ("fill-opacity" in bQ || "opacity" in bQ) {
          var d =
            ((+bR["fill-opacity"] + 1 || 2) - 1) *
            ((+bR.opacity + 1 || 2) - 1) *
            ((+aI.getRGB(bQ.fill).o + 1 || 2) - 1);
          d = bi(m(d, 0), 1);
          bO.opacity = d;
        }
        bQ.fill && (bO.on = true);
        ...
        bS && bN[bk](bO);
        var E =
            bN.getElementsByTagName("stroke") &&
            bN.getElementsByTagName("stroke")[0],
          bT = false;
        !E && (bT = E = ay("stroke"));
        if (
          (bQ.stroke && bQ.stroke != "none") ||
          bQ["stroke-width"] ||
          bQ["stroke-opacity"] != null ||
          bQ["stroke-dasharray"] ||
          bQ["stroke-miterlimit"] ||
          bQ["stroke-linejoin"] ||
          bQ["stroke-linecap"]
        ) {
          E.on = true;
        ...
        E.opacity = d;
        bQ["stroke-linejoin"] &&
          (E.joinstyle = bQ["stroke-linejoin"] || "miter");
        E.miterlimit = bQ["stroke-miterlimit"] || 8;
        bQ["stroke-linecap"] &&
          (E.endcap =
            bQ["stroke-linecap"] == "butt"
              ? "flat"
              : bQ["stroke-linecap"] == "square"
                ? "square"
                : "round");
        if (bQ["stroke-dasharray"]) {
          ...
          E.dashstyle = bL[ag](bQ["stroke-dasharray"])
            ? bL[bQ["stroke-dasharray"]]
            : aP;
        }
        bT && bN[bk](E);
      }
      if (bV.type == "text") {
        ...
        bV.node.string &&
          (bV.paper.span.innerHTML = bC(bV.node.string)
            [bs](/</g, "&#60;")
            [bs](/&/g, "&#38;")
            [bs](/\n/g, "<br>"));
    ...
    g = function (b, bH) {
      ...
      bH = bC(bH)[bs](aO, function (bM, bN, i) {
        ...
        if (bN && i) {
          bN = aj(bN);
          i = aj(i);
          bl(bN - 0.5, 2) + bl(i - 0.5, 2) > 0.25 &&
            (i = ao.sqrt(0.25 - bl(bN - 0.5, 2)) * ((i > 0.5) * 2 - 1) + 0.5);
          S = bN + aH + i;
        }
        return aP;
      });
    ...
    bc.attr = function (b, bH) {
      ...
      if (d) {
        for (var bI in this.paper.customAttributes) {
          if (
            this.paper.customAttributes[ag](bI) &&
            d[ag](bI) &&
            aI.is(this.paper.customAttributes[bI], "function")
          ) {
        ...
        if (
          d.gradient &&
          ({ circle: 1, ellipse: 1 }[ag](this.type) ||
            bC(d.gradient).charAt() != "r")
        ) {
          g(this, d.gradient);
        }
    ...
    ae = function (d, b, bH, R) {
      ...
      var i = new aU(S, E, d);
      i.type = "circle";
      an(i, { stroke: "#000", fill: "none" });
      i.attrs.cx = b;
      i.attrs.cy = bH;
      i.attrs.r = R;
      i.setBox({ x: b - R, y: bH - R, width: R * 2, height: R * 2 });
      d.canvas[bk](E);
      return i;
    };
    ...
    az = function (b, bI, bH, e, d) {
      ...
      R.attrs.rx = e;
      R.attrs.ry = d;
      R.setBox({ x: bI - e, y: bH - d, width: e * 2, height: d * 2 });
      b.canvas[bk](E);
      return R;
    };
    v = function (d, b, bH, S, bI, i) {
      ...
      R.attrs.w = bI;
      R.attrs.h = i;
      R.setBox({ x: bH, y: S, width: bI, height: i });
      d.canvas[bk](E);
      return R;
    };
    ak = function (d, bI, bH, bJ) {
      ...
      R.attrs.w = 1;
      R.attrs.h = 1;
      an(R, { font: q.font, stroke: "none", fill: "#000" });
      R.setBox();
      d.canvas[bk](E);
      return R;
    };
    ...
    try {
      !aa.namespaces.rvml &&
        aa.namespaces.add("rvml", "urn:schemas-microsoft-com:vml");
      ay = function (b) {
      ...
      ay = function (b) {
        return aa.createElement(
          "<" + b + ' xmlns="urn:schemas-microsoft.com:vml" class="rvml">',
        );
      };
    }
    F = function () {
  ...
  if (
    ...
    ((U && U[1] < 4) || navigator.platform.slice(0, 2) == "iP")
  ) {
    aZ.safari = function () {
  ...
  var O = function () {
      ...
      if (aa.addEventListener) {
        return function (R, i, e, d) {
          ...
          var E = function (bJ) {
            if (W && bq[ag](i)) {
              for (
                var bH = 0, bI = bJ.targetTouches && bJ.targetTouches.length;
                bH < bI;
                bH++
              ) {
    ...
    f = function (E) {
      ...
      while (d--) {
        ...
        b.el._drag = {};
        b.end &&
          b.end.call(b.end_scope || b.start_scope || b.move_scope || b.el, E);
      }
      a8 = [];
    };
  for (var ar = Q[s]; ar--; ) {
  ...
  bc.scale = function (bZ, bY, bQ, bO) {
    ...
    if (bZ != 0) {
      ...
      if (this.type in { text: 1, image: 1 } && (bP != 1 || bN != 1)) {
        if (this.transformations) {
          ...
          b0.filter =
            (this.node.filterMatrix || aP) + (this.node.filterOpacity || aP);
        }
      } else {
        if (this.transformations) {
  ...
  var a2 = {},
    ...
    a1 = function (b, d) {
      return function (bP, R, S) {
        ...
        for (var bI = 0, bN = bP.length; bI < bN; bI++) {
          ...
          if (e[0] == "M") {
            ...
            if (bJ + bH > R) {
              ...
              if (!b && !d) {
                bM = l(bL, bK, e[1], e[2], e[3], e[4], e[5], e[6], R - bJ);
                return { x: bM.x, y: bM.y, alpha: bM.alpha };
              }
            }
            bJ += bH;
            bL = +e[5];
        ...
        bM.alpha && (bM = { x: bM.x, y: bM.y, alpha: bM.alpha });
        return bM;
      };
    };
  var aK = a1(1),
  ...
  var X = [],
      ...
      for (var bT = 0; bT < X[s]; bT++) {
        ...
        if (R < bQ) {
              ...
              switch (am[bR]) {
                ...
                case "colour":
                  b =
                    "rgb(" +
                    [
                      K(ad(bU[bR].r + E * bQ * bN[bR].r)),
                      K(ad(bU[bR].g + E * bQ * bN[bR].g)),
                ...
                case "csv":
                  switch (bR) {
                    ...
                    case "scale":
                      b = [
                        +bU[bR][0] + E * bQ * bN[bR][0],
                        +bU[bR][1] + E * bQ * bN[bR][1],
                        2 in d[bR] ? d[bR][2] : aP,
                        3 in d[bR] ? d[bR][3] : aP,
                      ][aW](aH);
                      break;
          ...
          if (d.along) {
            ...
            bH.translate(
              bN.sx - (bN.x || 0) + bS.x - bN.sx,
              bN.sy - (bN.y || 0) + bS.y - bN.sy,
            );
            d.rot && bH.rotate(bN.r + bS.alpha, bS.x, bS.y);
          }
    ...
    A = function (b, e) {
      ...
      switch (this.type) {
        case "circle":
        case "ellipse":
          this.attr({ cx: +b + this.attrs.cx, cy: +e + this.attrs.cy });
          break;
        case "rect":
        case "image":
        case "text":
          this.attr({ x: +b + this.attrs.x, y: +e + this.attrs.y });
          break;
        case "path":
  ...
  bc.animate = function (b0, bQ, bP, R) {
          ...
          switch (am[bR]) {
            ...
            case "csv":
              ...
              switch (bR) {
                ...
                case "rotation":
                  bU[bR] =
                    bJ[1] == b[1] && bJ[2] == b[2] ? bJ : [0, b[1], b[2]];
    ...
    if (!S) {
      ...
      bO.sort(bm);
      if (bO[0].key) {
        bO.unshift({ key: 0, value: d.attrs });
      }
      for (bX = 0, bK = bO[s]; bX < bK; bX++) {
        by(
          ...
          d,
          (bQ / 100) * bO[bX].key,
          (bQ / 100) * ((bO[bX - 1] && bO[bX - 1].key) || 0),
          bO[bX - 1] && bO[bX - 1].value.callback,
        );
      }
  ...
  ah[bE].animate = function (d, b, S, bI) {
    ...
    while (e--) {
      this.items[e] &&
        !this.items[e].removed &&
        this.items[e].animateWith(bJ, d, b, S, E);
    }
    return this;
  };
  ...
  ah[bE].getBBox = function () {
    ...
    b = bi[bB](0, b);
    S = bi[bB](0, S);
    return { x: b, y: S, width: m[bB](0, d) - b, height: m[bB](0, E) - S };
  };
        ...
        if (d.glyphs[ag](E)) {
          ...
          i.glyphs[E] = {
            ...
            d:
              R.d &&
              "M" +
                R.d[bs](/[mlcxtrv]/g, function (bH) {
                  return (
                    { l: "L", c: "C", x: "z", t: "m", r: "l", v: "c" }[bH] ||
                    "M"
                  );
                }) +
                "z",
  ...
  aZ.getFont = function (bI, bJ, d, E) {
    ...
    d = d || "normal";
    bJ =
      +bJ || { normal: 400, bold: 700, lighter: 300, bolder: 800 }[bJ] || 400;
    if (!aI.fonts) {
      return;
    }
    var R = aI.fonts[bI];
    ...
    if (bI) {
      ...
      var e = bI.face.bbox.split(a),
        ...
        bK =
          +e[1] +
          (bS == "baseline"
            ? e[3] - e[1] + +bI.face.descent
            : (e[3] - e[1]) / 2);
      for (var bN = 0, S = bR[s]; bN < S; bN++) {
        var bL = (bN && bI.glyphs[bR[bN - 1]]) || {},
          bQ = bI.glyphs[bR[bN]];
        bP += bN
          ? (bL.w || bI.w) + ((bL.k && bL.k[bR[bN]]) || 0) + bI.w * d
          : 0;
        bQ &&
          bQ.d &&
          bO[k](
  ...
  aI.format = function (d, e) {
    ...
    d &&
      aI.is(d, af) &&
      b[s] - 1 &&
      (d = d[bs](bn, function (R, E) {
        return b[++E] == null ? aP : b[E];
      }));
    return d || aP;
  };
  aI.ninja = function () {
    r.was ? (aQ.Raphael = r.is) : delete window.Raphael;
    return aI;
  };
  aI.el = bc;
  aI.st = ah[bE];
