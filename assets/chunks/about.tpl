<div class="flex items-center justify-center gap-x-4 xl:gap-x-8 text-[#FFB35B]">
       <img class="w-[76px] h-[10px] xl:w-[115px] xl:h-[15px]" src="/assets/images/bubles.png" alt="">
        <h1 class="text-[30px] xl:text-[50px] font-balkara">О ПРОЕКТЕ</h1>
        <img class="w-[76px] h-[10px] xl:w-[115px] xl:h-[15px]" src="/assets/images/bubles.png" alt="">
</div>

<div class="mx-4 my-6 xl:m-20">
    <!-- Вводная карточка -->
    <div class="flex flex-col xl:flex-row items-center xl:items-center justify-center xl:justify-between gap-0 xl:gap-0 bg-[#D9D9D9]/20 rounded-2xl px-4 py-6 xl:p-10 text-white font-semibold">
        ...
        <p class="xl:hidden text-base leading-snug text-justify text-xl">
        ...
        <span class="hidden xl:block w-1/4 text-xl">Звучащая карта "Голоса&nbsp;народов России"</span>
        <span class="hidden xl:block w-[40%] text-xl">цифровая платформа аудиосказок наязыках&nbsp;народов&nbsp;Российской&nbsp;Федерации.</span>
    </div>

    <!-- Декоративный орнамент между вводной карточкой и текстом (только мобильный) -->
    <div class="mx-10 flex justify-center my-6 xl:hidden">
        <img class="object-contain h-12" src="/assets/images/emblem-about-horizontal.png" alt="">
    </div>
    ...
    <div class="grid grid-cols-1 xl:grid-cols-12 justify-between gap-x-0 xl:gap-x-10 mt-0 xl:mt-10">
        <div class="text-white text-sm xl:text-xl text-justify flex flex-col xl:flex-row justify-center items-center gap-y-4 xl:gap-y-0 gap-x-0 xl:gap-x-10 col-span-1 xl:col-span-8">
            <img class="hidden xl:block w-[97px] min-w-[97px]" src="/assets/images/emblem-about.png" alt="">
        ...
        <div class="flex flex-col gap-y-4 xl:gap-y-10 col-span-1 xl:col-span-4 mt-6 xl:mt-0">
            ...
            <div class="flex flex-col justify-center items-center gap-y-3 xl:gap-y-6 rounded-2xl p-4 xl:p-10 border-2 border-[#EFEADE] text-base xl:text-[20px] font-semibold text-center">
                <div class="flex flex-col items-center gap-y-2">
                    ...
                    <span class="text-white text-xl">Слушайте, сохраняйте и делитесь!</span>
                </div>
                <span class="text-[#FFB35B] text-xl">Пусть языки народов России&nbsp;зазвучат!</span>
            </div>
        </div>
    </div>
</div>
