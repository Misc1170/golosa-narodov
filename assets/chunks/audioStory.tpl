<div class="flex">
    <!-- КАРТИНКА -->
     <div class="flex justify-center items-end mr-20">
    ...
    <div class="flex flex-col gap-6 flex-grow">
        ...
        <div class="audio-container w-full" data-audio-root>
            ...
            <div class="flex items-center w-full transition-all duration-500 ease-in-out gap-4">
                <div class="relative flex items-center h-9 rounded-full flex-grow transition-all duration-500 overflow-hidden" data-player-bar>
                    <div class="relative z-20 flex items-center h-full">
                        <button class="pl-4 pr-3 h-full flex items-center justify-center cursor-pointer bg-[#FFB35B]/70" data-base-color="bg-[#FFB35B]/70" data-play-btn>
                        ...
                        <div class="w-[1px] h-full bg-[#0F212F]/50" data-divider></div>
                    </div>
        ...
        <div class="audio-container w-full" data-audio-root>
            ...
            <div class="flex items-center w-full transition-all duration-500 ease-in-out gap-4">
                <div class="relative flex items-center h-10 rounded-full flex-grow transition-all duration-500 overflow-hidden" data-player-bar>
                    <div class="relative z-20 flex items-center h-full">
                        <button class="pl-4 pr-3 h-full flex items-center justify-center cursor-pointer bg-[#EFEADE]/70" data-base-color="bg-[#EFEADE]/70" data-play-btn>
                            <div class="play-icon border-l-[12px] border-l-[#0F212F] border-y-[8px] border-y-transparent ml-1"></div>
                            <div class="pause-icon hidden flex gap-1"><div class="w-1.5 h-4 bg-[#0F212F]"></div><div class="w-1.5 h-4 bg-[#0F212F]"></div></div>
                        </button>
                        <div class="w-[1px] h-full bg-[#0F212F]/50" data-divider></div>
                    </div>
                    <div class="relative flex-grow h-full cursor-pointer flex items-center px-3 bg-[#EFEADE]/70" data-progress-area>
                        <span class="relative z-10 text-sm font-mono text-[#0F212F]" data-duration>00:00</span>
                        <div class="absolute top-0 left-0 h-full bg-[#EFEADE] pointer-events-none transition-all duration-100" data-progress style="width: 0%"></div>
                    </div>
